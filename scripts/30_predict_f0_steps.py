...
if __name__ == '__main__':
	...
	sign_dictionary_path = sys.argv[2]
	magn_dictionary_path = sys.argv[3]
	...
	sign_dict = load_dictionary(sign_dictionary_path)
	magn_dict = load_dictionary(magn_dictionary_path)
